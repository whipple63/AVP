...
public class EXO2Data {
    ...
    */
    public EXO2Data(final List<String> identifiers, final String rawLine) {
        ...
        if ( identifiers.size() != fields.size() ) {
            Logger.getLogger().log("Raw sonde data not expected size: "+rawLine, "EXO2Data", LogLevel.DEBUG);
        } else {
    ...
    */
    private final static Map<String, ElementDesc> initializeMap() {
        ...
        // EXO Sonde additions
        m.put("223" , new ElementDesc("223",  "turbidity_FNU", "FNU"));
        m.put("224" , new ElementDesc("224",  "turbidity_raw", "raw"));
        m.put("225" , new ElementDesc("225",  "bga-pc_ugL", "ug/L"));
        m.put("226" , new ElementDesc("226",  "bga-pe_ugL", "ug/L"));
        m.put("227" , new ElementDesc("227",  "fDOM_RFU", "RFU"));
        m.put("228" , new ElementDesc("228",  "fDOM_QSU", "QSU"));
        m.put("229" , new ElementDesc("229",  "wiper_pos", "V"));
        m.put("230" , new ElementDesc("230",  "external_power", "V"));
        m.put("231" , new ElementDesc("231",  "bga-pc_raw", "raw"));
        m.put("232" , new ElementDesc("232",  "bga-pe_raw", "raw"));
        m.put("233" , new ElementDesc("233",  "fDOM_raw", "raw"));
        m.put("234" , new ElementDesc("234",  "chlorophyll_raw", "raw"));
        m.put("235" , new ElementDesc("235",  "potassium_mV", "mV"));
        m.put("236" , new ElementDesc("236",  "potassium_mgL", "mg/L"));
        m.put("237" , new ElementDesc("237",  "NLF-cond_mScm", "mS/cm"));
        m.put("238" , new ElementDesc("238",  "NLF-cond_uScm", "uS/cm"));
        m.put("239" , new ElementDesc("239",  "wiper_peak_current", "mA"));
        m.put("240" , new ElementDesc("240",  "vertical_pos_m", "m"));
        m.put("241" , new ElementDesc("241",  "vertical_pos_ft", "ft"));
        return m;
    }
}
